...
public class TimePickerDialog {
    ...
    private View initTimePicker() {
        View inflate = LayoutInflater.from(mContext).inflate(R.layout.timepicker_layout, null);
    ...
    private View initDateAndTimePicker() {
        ...
        mTimePicker =  inflate.findViewById(R.id.dateAndTimePicker_timePicker);
        mDatePicker =  inflate.findViewById(R.id.dateAndTimePicker_datePicker);
        mTimePicker.setIs24HourView(true);
        resizePikcer(mTimePicker);
        resizePikcer(mDatePicker);
        return inflate;
    ...
    public void setOnTimePickerDialogInterface(TimePickerDialogInterface timePickerDialogInterface){
